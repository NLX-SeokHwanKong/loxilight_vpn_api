...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LoxilightVpnApi.IKEPolicyEntry = factory(root.LoxilightVpnApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The IKEPolicyEntry model module.
   * @module model/IKEPolicyEntry
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>IKEPolicyEntry</code>.
   * @alias module:model/IKEPolicyEntry
   * @class
  ...
  /**
   * Constructs a <code>IKEPolicyEntry</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IKEPolicyEntry} obj Optional instance to populate.
   * @return {module:model/IKEPolicyEntry} The populated <code>IKEPolicyEntry</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('phase1_negotiation_mode'))
        obj.phase1NegotiationMode = ApiClient.convertToType(data['phase1_negotiation_mode'], 'String');
      ...
      if (data.hasOwnProperty('ike_version'))
        obj.ikeVersion = ApiClient.convertToType(data['ike_version'], 'String');
    }
    return obj;
  }
   ...
   * @member {String} phase1NegotiationMode
   */
  exports.prototype.phase1NegotiationMode = undefined;
   ...
   * @member {String} ikeVersion
   */
  exports.prototype.ikeVersion = undefined;
