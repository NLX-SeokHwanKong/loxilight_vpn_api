...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IKEPolicyEntry', function() {
      beforeEach(function() {
        instance = new LoxilightVpnApi.IKEPolicyEntry();
      });

      it('should create an instance of IKEPolicyEntry', function() {
        // TODO: update the code to test IKEPolicyEntry
        expect(instance).to.be.a(LoxilightVpnApi.IKEPolicyEntry);
      });
      ...
      it('should have the property phase1NegotiationMode (base name: "phase1_negotiation_mode")', function() {
        // TODO: update the code to test the property phase1NegotiationMode
        expect(instance).to.have.property('phase1NegotiationMode');
        // expect(instance.phase1NegotiationMode).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property ikeVersion (base name: "ike_version")', function() {
